...
// SyncMap is a concurrent map with generic key and value types.
...
func (m *SyncMap[K, V]) CompareAndSwap(key, old, new any) (swapped bool) {
...
func (m *SyncMap[K, V]) Swap(key, value any) (previous any, loaded bool) {
